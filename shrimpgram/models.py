...
class Shrimp(models.Model):
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_shrimps', verbose_name='양식장명')
    group = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='group_shrimps', verbose_name='양식종류')
    location = models.CharField(max_length=100, null=True, blank=True, verbose_name='호지구분')
    ...
    naoh = models.IntegerField(default=0, null=True, blank=True, verbose_name='알칼리')
    ...
    date = models.DateTimeField(null=True, blank=True, default=timezone.now, verbose_name='수정일시')
...
class Sshrimp(models.Model):
    author = models.CharField(max_length=100, null=True, blank=True, verbose_name='양식장명')
    group = models.CharField(max_length=100, null=True, blank=True, verbose_name='양식종류')
    location = models.CharField(max_length=100, null=True, blank=True, verbose_name='호지구분')
    subject = models.CharField(max_length=100, null=True, blank=True, verbose_name='장치종류')
    serial = models.CharField(max_length=100, verbose_name='장치번호')
    temp = models.IntegerField(default=0, null=True, blank=True, verbose_name='온도(*C)')
