...
class File(models.Model):
    ...
    department = models.CharField(max_length=20, null=True, verbose_name='담당부서')
    charge = models.CharField(max_length=50, null=True, verbose_name='담당자')
    manager = models.CharField(max_length=50, default='확인 요망', verbose_name='관리자')
    director = models.CharField(max_length=50, default='확인 요망', verbose_name='승인역')
    super = models.CharField(max_length=50, default='확인 요망', verbose_name='추인역')
...
class Sfile(models.Model):
    ...
    group = models.CharField(max_length=20, null=True, verbose_name='아파트명')
