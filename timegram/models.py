...
class Time(models.Model):
    ...
    group = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='group_times', verbose_name='사용목적')
    ...
    remark = models.CharField(max_length=100, null=True, blank=True, default='', verbose_name='비고')
